	...
	return (
		<section>
			<div className="container">
				<h1 className="h3 py-30">Most Searched schools</h1>
				<div className="columns">
					...
					<div className="col-6">
						<div className="columns">
								...
								<div className="overlay-sm">
									...
									<div className="overlay">
										<div className="overlay-details">
											<h1 className="h4">University of Ibadan(UI)</h1>
											<div className="justify-center">
												<div className="reaction ">
													...
													<div className="reaction-count color-white">56k Views/Searches</div>
												</div>
											</div>
										</div>
									</div>
										...
										<div className="space-between">
											<div className="flex-start">
												<div className="reaction ">
													...
													<div className="reaction-count">56</div>
												</div>
											</div>
											<div className="flex-end">
												<div className="reaction">
													...
													<div className="reaction-count">44</div>
												</div>
							...
							<div className="col-6">
								<div className="overlay-sm">
									<img src="./UI/assets/images/school.jpg" alt="" />
									<div className="overlay">
										<div className="overlay-details">
											<h1 className="h4">University of Calabar(UNICAL)</h1>
											<div className="justify-center">
												<div className="reaction ">
													<div className="reaction-icon">
														<svg
							...
							<div className="col-6">
								<div className="overlay-sm">
									<img src="./UI/assets/images/antiq.jpg" alt="" />
									<div className="overlay">
										<div className="overlay-details">
											<h1 className="h4">University of Lagos(UNILAG)</h1>
											<div className="justify-center">
												<div className="reaction ">
													<div className="reaction-icon">
														<svg
							...
							<div className="col-6">
								<div className="overlay-sm">
									...
									<div className="overlay">
										<div className="overlay-details">
											<h1 className="h4">University of Jos(UNIJOS)</h1>
											<div className="justify-center">
												<div className="reaction ">
													<div className="reaction-icon">
														<svg
