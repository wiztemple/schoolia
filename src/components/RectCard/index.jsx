	...
	return (
		<div className="col-6">
			<div className="rectcard">
				<img className="rectcard-image" src={schoolimage} alt="dawn" />
				<div className="rectcard-content">
					<div className="rectcard-title">Federal University of Technology, Minna(FUTMINNA)</div>
					<div className="mt-10">
						<div className="rectcard-desc">Lorem ipsum dolor sit amet consectetur...</div>
						<div className="flex-start">
							<span className="property-key">Location:</span>
							<span className="property-name">Minna, Niger State</span>
						</div>
						<div className="flex-start pb-20">
							<span className="property-key">Website:</span>
							<span className="property-name">www.futminna.edu.ng</span>
						</div>
					</div>
					<div className="rectcard-footer">
						<div className="flex-start">
